    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Sesuaikan opsi paket, harga bulanan, batasan sistem, dan daftar fitur.</p>
            </div>
        </div>
            ...
            <form method="POST" action="{{ route('admin.plans.update', $plan) }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name', $plan->name) }}" required class="w-full bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-700 rounded-xl py-2.5 px-4 text-xs focus:ring-2 focus:ring-rose-500 focus:border-rose-500 dark:focus:ring-offset-gray-900 focus:outline-none text-gray-900 dark:text-white transition-all">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="price" value="{{ old('price', (int) $plan->price) }}" required class="w-full bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-700 rounded-xl py-2.5 px-4 text-xs focus:ring-2 focus:ring-rose-500 focus:border-rose-500 dark:focus:ring-offset-gray-900 focus:outline-none text-gray-900 dark:text-white transition-all">
                    ...
                    <div>
                        ...
                        <input type="number" name="max_projects" value="{{ old('max_projects', $plan->max_projects) }}" required class="w-full bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-700 rounded-xl py-2.5 px-4 text-xs focus:ring-2 focus:ring-rose-500 focus:border-rose-500 dark:focus:ring-offset-gray-900 focus:outline-none text-gray-900 dark:text-white transition-all">
                    ...
                    <div>
                        ...
                        <input type="number" name="max_team_members" value="{{ old('max_team_members', $plan->max_team_members) }}" required class="w-full bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-700 rounded-xl py-2.5 px-4 text-xs focus:ring-2 focus:ring-rose-500 focus:border-rose-500 dark:focus:ring-offset-gray-900 focus:outline-none text-gray-900 dark:text-white transition-all">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex items-center gap-3 bg-gray-50 dark:bg-gray-900 p-4 rounded-xl border border-gray-100 dark:border-gray-800">
                        <input type="checkbox" name="has_custom_landing" id="has_custom_landing" value="1" {{ old('has_custom_landing', $plan->has_custom_landing) ? 'checked' : '' }} class="rounded text-rose-500 focus:ring-rose-500 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700">
                    ...
                    <div class="flex items-center gap-3 bg-gray-50 dark:bg-gray-900 p-4 rounded-xl border border-gray-100 dark:border-gray-800">
                        <input type="checkbox" name="has_client_dashboard" id="has_client_dashboard" value="1" {{ old('has_client_dashboard', $plan->has_client_dashboard) ? 'checked' : '' }} class="rounded text-rose-500 focus:ring-rose-500 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700">
                ...
                <div>
                    ...
                    <textarea name="features" rows="5" required class="w-full bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-700 rounded-xl py-2.5 px-4 text-xs focus:ring-2 focus:ring-rose-500 focus:border-rose-500 dark:focus:ring-offset-gray-900 focus:outline-none text-gray-900 dark:text-white transition-all">{{ old('features', $featuresString) }}</textarea>

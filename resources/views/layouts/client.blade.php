        ...
        <div class="min-h-screen flex">
            ...
            <aside class="w-64 bg-white dark:bg-gray-800 border-r border-gray-100 dark:border-gray-700 flex flex-col transition-all duration-300 shrink-0"
                ...
                <nav class="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto">
                    ...
                    <a href="{{ route('client.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all group bg-purple-50 text-purple-600 dark:bg-purple-900/30 dark:text-purple-400">

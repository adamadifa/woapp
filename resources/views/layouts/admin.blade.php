        ...
        <div class="min-h-screen flex">
            ...
            <aside class="w-64 bg-white dark:bg-gray-800 border-r border-gray-100 dark:border-gray-700 flex flex-col transition-all duration-300 shrink-0"
                ...
                <nav class="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto">
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all group bg-indigo-50 text-indigo-600 dark:bg-indigo-900/30 dark:text-indigo-400">
